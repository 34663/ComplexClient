package complex.gui.altmanager;
...
import complex.gui.altmanager.althening.GuiAlthening;
import complex.gui.altmanager.althening.althening.AltService;
import complex.utils.file.files.Alts;
...
public class GuiAltManager extends GuiScreen {
   ...
   public void actionPerformed(GuiButton button) {
      switch (button.id) {
         ...
         case 2:
            ...
            try {
               Complex.getFileManager().getFile(Alts.class).saveFile();
         ...
         case 8:
            try {
               ...
               Complex.getFileManager().getFile(Alts.class).loadFile();
   ...
   public void drawScreen(int par1, int par2, float par3) {
      ...
      //RenderUtil.drawRect(0.0D, 0.0D, (double)this.width, (double)this.height, Colors.getColor(0, 255));
      if (Mouse.hasWheel()) {
      ...
      RenderingUtils.drawBorderedRect(50.0D, 33.0D, (double) (this.width - 50), (double) (this.height - 50), 1.0F, Colors.getColor(225, 50), Colors.getColor(160, 150));
      GL11.glPushMatrix();
      ...
      while (true) {
         ...
         if (alt != this.selectedAlt) {
            if (this.isMouseOverAlt(par1, par2, y - this.offset) && Mouse.isButtonDown(0)) {
               RenderingUtils.drawBorderedRect(52.0D, (double) (y - this.offset - 4), (double) (this.width - 52), (double) (y - this.offset + 20), 1.0F, -Colors.getColor(145, 50), -2146101995);
            } else if (this.isMouseOverAlt(par1, par2, y - this.offset)) {
               RenderingUtils.drawBorderedRect(52.0D, (double) (y - this.offset - 4), (double) (this.width - 52), (double) (y - this.offset + 20), 1.0F, Colors.getColor(145, 50), -2145180893);
            }
         } else {
            if (this.isMouseOverAlt(par1, par2, y - this.offset) && Mouse.isButtonDown(0)) {
               RenderingUtils.drawBorderedRect(52.0D, (double) (y - this.offset - 4), (double) (this.width - 77), (double) (y - this.offset + 20), 1.0F, Colors.getColor(145, 50), -2142943931);
            } else if (this.isMouseOverAlt(par1, par2, y - this.offset)) {
               RenderingUtils.drawBorderedRect(52.0D, (double) (y - this.offset - 4), (double) (this.width - 77), (double) (y - this.offset + 20), 1.0F, Colors.getColor(145, 50), -2142088622);
            } else {
               RenderingUtils.drawBorderedRect(52.0D, (double) (y - this.offset - 4), (double) (this.width - 77), (double) (y - this.offset + 20), 1.0F, Colors.getColor(145, 50), -2144259791);
            }

            boolean hovering = par1 >= this.width - 76 && par1 <= this.width - 52 && par2 >= y - this.offset - 4 && par2 <= y - this.offset + 20;
            RenderingUtils.drawBorderedRect((double) (this.width - 76), (double) (y - this.offset - 4), (double) (this.width - 52), (double) (y - this.offset + 20), 1.0F, Colors.getColor(80, 255), hovering ? -1 : Colors.getColor(20, 255));
   ...
   public void initGui() {
      Complex.getDiscordrpc().update("Idle.", "AltSelected xd");
      ...
      this.buttonList.add(new GuiButton(8931, this.width / 2 + 190, 5, 100, 20, "MultiPlayer"));
      this.login.enabled = false;
      this.remove.enabled = false;
      this.rename.enabled = false;
   }
