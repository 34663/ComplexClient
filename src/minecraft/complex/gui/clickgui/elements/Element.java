...
public class Element {
	...
	public void setup() { clickgui = parent.parent.clickgui; }
	...
	public boolean isHovered(int mouseX, int mouseY) { return mouseX >= x && mouseX <= x + width && mouseY >= y && mouseY <= y + height; }
}
