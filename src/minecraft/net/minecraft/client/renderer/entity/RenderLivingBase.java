...
import complex.module.impl.misc.CivBreak;
import complex.module.impl.movement.Scaffold;
import complex.module.impl.movement.TestScaffold;
...
public abstract class RenderLivingBase<T extends EntityLivingBase> extends Render<T> {
    ...
    public static float renderLimbSwing;
    public static float renderLimbSwingAmount;
    public static float renderAgeInTicks;
    public static float renderHeadYaw;
    public static float renderHeadPitch;
    public static float renderScaleFactor;
    ...
    public static void setPitchHead(final float perspitch) {
        RenderLivingBase.renderHeadPitch = perspitch;
    }

    public static float getPreviousPitchHead() {
        return RenderLivingBase.previousPitchHead;
    }

    public static void setPreviousPitchHead(final float perspitch) {
        RenderLivingBase.previousPitchHead = perspitch;
    }
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks) {
        if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, entity, this, partialTicks, x, y, z)) {
            if (Complex.getModuleManager().isEnabled("Chams") && Complex.getSettingsManager().getSettingByName("Chams Mode").getValString().equalsIgnoreCase("Wall") && Complex.getSettingsManager().getSettingByName("Entitys").getValBoolean() && entity instanceof EntityPlayer) {
            ...
            try {
                ...
                if (entity instanceof EntityPlayer) {
                    EventRenderEntity em = new EventRenderEntity(entity, true, f6, f5, f8, f2, f7, f, 0.0625F);
                    em.call();
                    if (em.isCancelled()) {
                        return;
                    }
    ...
    public void renderModel(T entitylivingbaseIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor) {
        ...
        if (flag || flag1) {
            ...
            if (Complex.getModuleManager().isEnabled("Outline") && entitylivingbaseIn instanceof EntityPlayer) {
                ...
                OutlineUtils.renderOne(Complex.getSettingsManager().getSettingByName("LineWidth").getValFloat());
    ...
    public void renderName(T entity, double x, double y, double z) {
        EventRenderNameTags renderNameTags = new EventRenderNameTags(entity);
        renderNameTags.call();
        if (renderNameTags.isCancelled()) {
            return;
        }
