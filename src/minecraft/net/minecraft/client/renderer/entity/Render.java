...
public abstract class Render<T extends Entity> implements IEntityRenderer {
    ...
    protected void renderEntityName(T entityIn, CFontRenderer fontRenderer, double x, double y, double z, String name, double distanceSq) {
        this.renderLivingLabel(entityIn, fontRenderer, name, x, y, z, 64);
    }
    ...
    protected void renderLivingLabel(T entityIn, CFontRenderer font, String str, double x, double y, double z, int maxDistance) {
        double d0 = entityIn.getDistanceSqToEntity(this.renderManager.renderViewEntity);
        ...
        if (d0 <= (double) (maxDistance * maxDistance)) {
            ...
            float f2 = entityIn.height + 0.5F - (flag ? 0.25F : 0.0F);
            int i = "deadmau5".equals(str) ? -10 : 0;
            EntityRenderer.drawNameplate(font, str, (float) x, (float) y + f2, (float) z, i, f, f1, flag1, flag);
        }
    }
