...
public class TileEntityChestRenderer extends TileEntitySpecialRenderer<TileEntityChest> {
    ...
    public void func_192841_a(TileEntityChest tileEntityChest, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        ...
        if (tileEntityChest.hasWorldObj()) {
            ...
            if (block instanceof BlockChest && i == 0) {
                ((BlockChest) block).checkForSurroundingChests(tileEntityChest.getWorld(), tileEntityChest.getPos(), tileEntityChest.getWorld().getBlockState(tileEntityChest.getPos()));
                i = tileEntityChest.getBlockMetadata();
            }
        ...
        if (tileEntityChest.adjacentChestZNeg == null && tileEntityChest.adjacentChestXNeg == null) {
            ...
            if (tileEntityChest.adjacentChestXPos == null && tileEntityChest.adjacentChestZPos == null) {
                ...
                } else if (tileEntityChest.getChestType() == BlockChest.Type.TRAP) {
            ...
            GlStateManager.translate(-0.5F, -0.5F, -0.5F);
            float f = tileEntityChest.prevLidAngle + (tileEntityChest.lidAngle - tileEntityChest.prevLidAngle) * partialTicks;

            if (tileEntityChest.adjacentChestZNeg != null) {
                float f1 = tileEntityChest.adjacentChestZNeg.prevLidAngle + (tileEntityChest.adjacentChestZNeg.lidAngle - tileEntityChest.adjacentChestZNeg.prevLidAngle) * partialTicks;
            ...
            if (tileEntityChest.adjacentChestXNeg != null) {
                float f2 = tileEntityChest.adjacentChestXNeg.prevLidAngle + (tileEntityChest.adjacentChestXNeg.lidAngle - tileEntityChest.adjacentChestXNeg.prevLidAngle) * partialTicks;
