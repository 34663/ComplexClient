...
import complex.event.impl.EventKey;
...
public class Minecraft implements IThreadListener, ISnooperInfo {
    ...
    private void startGame() throws LWJGLException, IOException {
        ...
        //TODO SetupClient
        final Complex client = Complex.instance;
        client.setup();

        if (this.serverName != null) {
            this.displayGuiScreen(new GuiConnecting(new GuiMainMenu(), this, this.serverName, this.serverPort));
        } else {
            this.displayGuiScreen(Complex.Loggedin ? new GuiMainMenu() : new GuiLogin());
        }
    ...
    private void clickMouse() {
        if (this.leftClickCounter <= 0) {
            EventAttack attack = new EventAttack(objectMouseOver.entityHit, true);
            attack.call();
            ...
            if (this.objectMouseOver == null) {
                ...
                EventAttack attack1 = new EventAttack(objectMouseOver.entityHit, false);
