...
public abstract class GuiContainer extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(5000, 2, 3, 120, 20, "Toggle Aura"));
        this.buttonList.add(new GuiButton(6000, 2, 24, 120, 20, "Toggle AutoArmor"));
    }
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        ...
        for (Object aButtonList : this.buttonList) {
            ...
            if (var52.mousePressed(this.mc, mouseX, mouseY) && var52.id == 5000) {
                Complex.getModuleManager().getModule("Aura").toggle();
            }
            if (var52.mousePressed(this.mc, mouseX, mouseY) && var52.id == 6000) {
                Complex.getModuleManager().getModule("AutoArmor").toggle();
            }
        }
