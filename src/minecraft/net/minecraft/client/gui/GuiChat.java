...
public class GuiChat extends GuiScreen implements ITabCompleter {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        drawRect(1, this.height - 14, this.width - 2, this.height - 2, Colors.getColor(new Color(0, 0, 0, 200)));
        drawRect(this.width - 2, this.height - 14, this.width - 1, this.height - 2, Colors.getColor(new Color(255, 100, 100, 255)));
        drawRect(1, this.height - 14, 0, this.height - 2, Colors.getColor(new Color(255, 100, 100, 255)));
