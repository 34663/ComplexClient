...
public class GuiButton extends Gui {
    ...
    public void func_191745_a(Minecraft p_191745_1_, int p_191745_2_, int p_191745_3_, float p_191745_4_) {
        if (this.visible) {
            ...
            RenderingUtils.drawRoundedRect(this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + this.height, 2, this.enabled ? this.hovered ? Colors.getColor(50, 50, 50, 160) : Colors.getColor(0, 0, 0, 160) : Colors.getColor(150, 150, 150, 160));
