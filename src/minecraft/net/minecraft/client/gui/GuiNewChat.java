                    ...
                    if (chatline != null) {
                        ...
                        if (j1 < 200 || flag) {
                            ...
                            if (l1 > 3) {
                                int i2 = 0;
                                int j2 = -i1 * 9;
                                drawRect(-2, j2 - 9, 0 + k + 4, j2, Colors.getColor(new Color(0, 0, 10, 220)));
                                drawRect(0 + k + 4, j2 - 9, 0 + k + 5, j2, HUD.TwoColoreffect(new Color(255, 100, 100, 255), new Color(100, 50, 50, 255), Math.abs(System.currentTimeMillis() / 10L) / 100.0 + 3.0F * (j2 * 3) / 4).getRGB());
