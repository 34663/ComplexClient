...
import complex.gui.screen.GuiLogin;
import complex.utils.changelog.ChangeLog;
...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        CFontRenderer font = FontLoaders.Tahoma12;
        CFontRenderer font2 = FontLoaders.Tahoma22;
        int y = 19;
        int x = 4;
        font2.drawStringWithShadow("ChangeLog", 3, 5, 0xffffff);
        for (ChangeLog log : Complex.getChangeLogManager().getChangeLogs()) {
            font.drawStringWithShadow(log.getChangeName(), x, y, 0xffffff);
            y += 7;
        }
