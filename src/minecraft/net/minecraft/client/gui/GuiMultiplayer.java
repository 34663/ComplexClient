...
import complex.gui.altmanager.GuiAltManager;
import complex.gui.screen.GuiProxy;
...
public class GuiMultiplayer extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.User = "Login: " + this.mc.session.getUsername();
    ...
    public void createButtons() {
        ...
        this.buttonList.add(new GuiButton(9, this.width / 2 + 4 + 155, this.height - 52, 100, 20, "AltManager"));
        this.buttonList.add(new GuiButton(10, this.width / 2 + 4 + 155, this.height - 28, 100, 20, "Proxy"));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, User, this.width / 2, 8, 16777215);
        this.drawCenteredString(this.fontRendererObj, I18n.format("multiplayer.title"), this.width / 2, 18, 16777215);
