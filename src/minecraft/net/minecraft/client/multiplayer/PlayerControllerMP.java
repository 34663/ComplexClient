...
public class PlayerControllerMP {
    ...
    public boolean onPlayerDamageBlock(BlockPos posBlock, EnumFacing directionFacing) {
        final EventBlockBreaking event = new EventBlockBreaking(EventBlockBreaking.EnumBlock.DAMAGE, posBlock, directionFacing);
        event.call();
    ...
    public ItemStack windowClick(int windowId, int slotId, int mouseButton, ClickType type, EntityPlayer player) {
        ...
        Command.sendChatMessage("Slot " + slotId + ": DragType " + mouseButton + ": ClickType " + type);
        return itemstack;
    }
    ...
    public void onPlayerRightClick(EntityPlayerSP thePlayer, WorldClient theWorld, BlockPos position, EnumFacing face, Vec3d vec3d) {
        processRightClickBlock(thePlayer, theWorld, position, face , new Vec3d(vec3d.xCoord, vec3d.yCoord, vec3d.zCoord), EnumHand.MAIN_HAND);
    }
}
