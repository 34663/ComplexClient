...
public abstract class Entity implements ICommandSender {
    ...
    public void moveEntity(MoverType x, double p_70091_2_, double p_70091_4_, double p_70091_6_) {
        if (this.noClip) {
            ...
            final EventSafeWalk event = new EventSafeWalk();
            event.call();

            if ((((x == MoverType.SELF || x == MoverType.PLAYER) && this.onGround && this.isSneaking()) && this instanceof EntityPlayer) || (event.isCancelled() && this instanceof EntityPlayer)) {
