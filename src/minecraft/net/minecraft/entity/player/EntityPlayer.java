...
public abstract class EntityPlayer extends EntityLivingBase {
    ...
    public float getDigSpeed(IBlockState state) {
        ...
        if (this.isPotionActive(MobEffects.HASTE) && !Complex.getSettingsManager().getSettingByName("MineHaste").getValBoolean()) {
        ...
        if (this.isInsideOfMaterial(Material.WATER) && !EnchantmentHelper.getAquaAffinityModifier(this) && !Complex.getSettingsManager().getSettingByName("MineWater").getValBoolean()) {
            f /= 5.0F;
        }

        if (!this.onGround && !Complex.getSettingsManager().getSettingByName("MineGround").getValBoolean()) {
            f /= 5.0F;
        }
...
//                            this.setSprinting(false);
                        ...
                        if (flag3) {
                            ...
                            if (!Complex.getSettingsManager().getSettingByName("Fight").getValBoolean())
