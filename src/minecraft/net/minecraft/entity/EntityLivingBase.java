...
public abstract class EntityLivingBase extends Entity {
    ...
    public void onEntityUpdate() {
        ...
        EventLivingUpdate livingUpdate = new EventLivingUpdate(this);
        livingUpdate.call();
    }
    ...
    protected void jump() {
        ...
        if (this.isSprinting()) {
            ...
            float speed = 0.2f;
            if(Complex.getModuleManager().isEnabled("TestScaffold"))
                speed -= 0.12f;
            ...
            if (!this.isInWater() || this instanceof EntityPlayer && ((EntityPlayer) this).capabilities.isFlying) {
                if (!this.isInLava() || this instanceof EntityPlayer && ((EntityPlayer) this).capabilities.isFlying) {
                    if (this.isElytraFlying()) {
                        ...
                        this.moveEntity(MoverType.SELF, this.motionX, this.motionY, this.motionZ);
                        EventLadder el = new EventLadder(0.2D, true);
                        EventLadder el1 = new EventLadder(motionY, false);
                        el.call();

                        if (this.isCollidedHorizontally && this.isOnLadder()) {
                            this.motionY = el.getMotionY();
                        }
                        el1.call();
